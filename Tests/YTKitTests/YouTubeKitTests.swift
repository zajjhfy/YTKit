...
final class YouTubeKitTests: XCTestCase {
    ...
    private func checkStreamReachability(_ stream: YTKit.Stream?) async throws {
    ...
    private func isStreamReachable(_ stream: YTKit.Stream?) async throws -> Bool {
    ...
    private func checkAllStreamReachability(_ streams: [YTKit.Stream]) async throws {
    ...
    private func checkStreams(_ streams: [YTKit.Stream]) {
        for stream in streams {
